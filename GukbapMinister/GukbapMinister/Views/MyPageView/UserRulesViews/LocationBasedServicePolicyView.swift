            ...
            VStack  {
                LazyVStack {
                    Text("""
                         ...
                         본 약관은 회원(국밥부 장관 서비스 약관에 동의한 자를 말합니다. 이하 '회원'이라고 합니다)이 주식회사 GoodVibe(이하 '회사'라고 합니다.)가 제공하는 국밥부 장관 서비스(이하 '서비스'라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
